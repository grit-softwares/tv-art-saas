...
class SprayPaletteClienteSupabaseUser extends BaseAuthUser {
  SprayPaletteClienteSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> sprayPaletteClienteSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = SprayPaletteClienteSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
